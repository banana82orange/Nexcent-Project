...
function MeetCustomer() {
  ...
  return (
    <div className="py-10 ">
      <div className="container mx-auto max-w-[1920] p-10 grid grid-cols-1 md:grid-cols-2 items-start">
        ...
        <div className="">
          ...
          <div className="text-[#717171] my-5">
            British Dragon Boat Racing Association
          </div>

          <div className="grid grid-cols-[repeat(auto-fit,minmax(0,80px))] gap-2 justify-start justify-items-center">
            {clientLogos.map((item) => (
              <img src={item.img}></img>
            ))}

            <a
              className="inline-flex items-center  py-0 px-0 text-[#4CAF4F]"
              href="#"
            >
              Meet all customers
            </a>
