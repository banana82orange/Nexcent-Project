  ...
  return (
    <div className="bg-[#F5F7FA]">
        <div className=" h-auto container mx-auto max-w-[1920] p-10 grid grid-cols-1 md:grid-cols-2 md:justify-between md:items-center">
            <div>
                <div className='text-[2.3rem] font-semibold text-[#4D4D4D]'>Helping a local </div>
                <div className='text-[2.3rem] font-semibold text-[#4CAF4F]'>business reinvent itself</div>
                <div className='text-[1.0rem] font-semibold text-[#4D4D4D] mb-10'>We reached here with our hard work and dedication</div>
            </div>
            <div className="container  mx-auto grid grid-cols-2 gap-4">
                {data.map( (dataE) =>
                    <div className="flex items-center gap-4">
                        ...
                        <div className='my-2 '>
                            <div className='text-[2.3rem] text-[#4D4D4D]'>{dataE.number}</div>
